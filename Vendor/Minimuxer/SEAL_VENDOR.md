...
features Seal calls (`afc`, installation proxy, provisioning, image-mounter compatibility, heartbeat, DVT/debug proxy, remote pairing, RSD, and TCP). This intentionally
...
## Personalized DDI boundary

Personalized DDI mounting is outside Seal's signing/install/renewal closed loop
and is intentionally unavailable in this vendor. No Rust image-mounter feature
or FFI export is linked, preventing an unsupported API from blocking the bridge
build or producing a false-success result.
